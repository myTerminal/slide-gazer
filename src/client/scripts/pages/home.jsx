            ...
            <div id='home-page'>
                <div id='center-panel'>
                    ...
                    <span className='regular-text'>
                        Select 'Present' to present a slide-show or 'Control' to control one that is running.
                    </span>
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <span className='regular-text'>Source:</span> <a href='https://github.com/team-fluxion/slide-gazer' className='regular-text fa fa-github fa-lg' target='_blank'></a>
                </div>
            </div>
        );
    }
